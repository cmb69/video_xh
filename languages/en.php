...
$plugin_tx['video']['cf_default_align']="The alignment of the video: \"left\" (left), \"center\" (center) or \"right\" (right). This default can be overridden for each video in the plugin call.";
...
$plugin_tx['video']['cf_default_height']="The height of the video. This default can be overridden for each video in the plugin call.";
...
$plugin_tx['video']['cf_default_width']="The width of the video. This default can be overridden for each video in the plugin call.";
