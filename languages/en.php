...
$plugin_tx['video']['syscheck_phpversion']="PHP version ≥ %s";
$plugin_tx['video']['syscheck_success']="okay";
$plugin_tx['video']['syscheck_title']="System check";
$plugin_tx['video']['syscheck_warning']="warning";
$plugin_tx['video']['syscheck_writable']="'%s' is writable";
$plugin_tx['video']['syscheck_xhversion']="CMSimple_XH version ≥ %s";
...
$plugin_tx['video']['cf_default_description']="The description of the video, which is important information for Search Engines. This default is supposed to be overridden for each video in the plugin call.";
...
$plugin_tx['video']['cf_default_title']="The title of the video, which is important information for Search Engines. This default is supposed to be overridden for each video in the plugin call.";
