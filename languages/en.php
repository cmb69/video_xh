...
$plugin_tx['video']['label_subtitles'] = "Subtitles";
...
$plugin_tx['video']['syscheck_plibversion'] = "Plib_XH version ≥ %s";
...
$plugin_tx['video']['cf_default_subtitles'] = "Whether the subtitle track should be enabled. This default can be overridden for each video in the plugin call.";
