...
$plugin_tx['video']['cf_default_centered']="Whether the play button shall be displayed centered. This setting may not have effect for custom skins. This default can be overridden for each video in the plugin call.";
...
$plugin_tx['video']['cf_prefer_flash']="Whether to prefer flash video over html5 video.";
$plugin_tx['video']['cf_skin']="The name of a skin (e.g. \"tube\" or \"tube2\"). Leave empty to use the default skin.";
$plugin_tx['video']['cf_use_cdn']="Whether to use Video.js via CDN.";
