...
$plugin_tx['video']['cf_default_width']="The default width of the videos, if not explicitely specified in the plugin call.";
$plugin_tx['video']['cf_default_height']="The default height of the videos, if not explicitely specified in the plugin call.";
