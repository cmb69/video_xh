...
$plugin_tx['video']['cf_auto_resize']="Whether the video should be automatically resized to the size of its surrounding element: \"1\" (yes) or \"0\" (no).";
$plugin_tx['video']['cf_prefer_flash']="Whether to prefer flash video over html5 video: \"1\" (yes) or \"0\" (no). This default can be overridden for each video in the plugin call.";
